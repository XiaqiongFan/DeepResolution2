...
def DeepEFA(work_path,m,ind_st,ind_en,model_size,COM):
    ...
    restored_model = tf.keras.models.load_model(work_path+'/model/DeepEFA/'+str(COM)+'/model.h5')    
    y_DeepEFA = restored_model.predict(Xtest)

    return y_DeepEFA,Xtest
